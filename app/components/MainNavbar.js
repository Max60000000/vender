...
const MainNavbar = () => {
  ...
  return (
    <div>
       <nav id="navbar-main" class="navbar navbar-expand bg-blue sticky-top">
  ...
  <div class="row justify-content-end">
    <div class="col-2 bg-white border p-0">
      ...
      <ul class="navbar-nav">
        ...
        '<li class="nav-item"><a onclick="logout()"  style={{ cursor: 'pointer' }}; class="nav-link text-capitalize">
